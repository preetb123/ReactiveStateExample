 ...
 */
@Suppress("UNCHECKED_CAST")
public inline fun <reified T : ViewModel> LifecycleAndViewStoreOwnerService.stateFlowViewModel(
    crossinline provider: (handle: SavedStateHandleStore) -> T,
): Lazy<T> = ViewModelLazy(T::class, { ViewModelStore() }, { ViewModelProvider.AndroidViewModelFactory(application) }, { CreationExtras.Empty })
//    viewModels {
//        object : AbstractSavedStateViewModelFactory(this@stateFlowViewModel, null) {
//            override fun <T : ViewModel> create(
//                key: String,
...
public class MyViewModelFactory(public val arg: Int) : ViewModelProvider.Factory {
